	...
	<div class="dart-preloader">
		<div class="container">
			<div class="dart-preloader-items">
				<div class="dart-preloader-item">Сайт под ключ</div>
				<div class="dart-preloader-item">Интернет-магазин</div>
				<div class="dart-preloader-item">Landing page</div>
				<div class="dart-preloader-item">Персональный блог</div>
				<div class="dart-preloader-item">Дизайн сайта</div>
				<div class="dart-preloader-item">Логотип</div>
				<div class="dart-preloader-item">UI/UX</div>
				<div class="dart-preloader-item">Мобильное приложение</div>
...
<header id="header">
	<div class="container">
		...
		<div class="head-btn"><a href="#feedback" class="dart-btn call-back">Оставить заявку</a></div>
		<div>
			<div id="nav-icon">
			      <span></span>
			      <span></span>
