...
add_menu_page( __( 'Базовые', 'WP-Ember' ), __( 'Базовые', 'WP-Ember' ), 'edit_theme_options', 'price_options', 'theme_options_do_page', 'dashicons-editor-kitchensink', 4 );
}
...
<div class="wrap">
<?php screen_icon(); echo "<h2>". __( 'Базовые настройки', 'WP-Ember' ) . "</h2>"; ?>
