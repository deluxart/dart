 ...
 */
function dart_custom_colors_css() {
	...
	/**
	 * Filter DELUX-Art default saturation level.
	 *
	 * @since DELUX-Art 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'dart_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter DELUX-Art default selection saturation level.
	 *
	 * @since DELUX-Art 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'dart_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	/**
	 * Filter DELUX-Art default lightness level.
	 *
	 * @since DELUX-Art 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'dart_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter DELUX-Art default hover lightness level.
	 *
	 * @since DELUX-Art 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'dart_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filter DELUX-Art default selection lightness level.
	 *
	 * @since DELUX-Art 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = apply_filters( 'dart_custom_colors_lightness_selection', 90 );
	...
	/**
	 * Filters DELUX-Art custom colors CSS.
	 *
	 * @since DELUX-Art 1.0
	 *
	 ...
	 */
	return apply_filters( 'dart_custom_colors_css', $theme_css, $primary_color, $saturation );
}
